        ...
        <>
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                <Modal.Header closeButton>
                    <Modal.Title className='container modal-dialog' >
                        <div >
                                ...
                                <div>
                                    ...
                                    <div className='container'>
                                        {Array.isArray(comments) && comments.map((comment, index) => (
                                            <div className='' key={index} style={{ border: '1px grey solid', borderRadius: '10px', marginBottom: '10px', marginTop: '10px', backgroundColor:'#3a3d3f' }}>
